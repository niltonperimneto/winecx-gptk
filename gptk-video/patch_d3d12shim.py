...
#ifndef D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS_DEFINED
#define D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS_DEFINED
...
typedef struct D3D12_VIDEO_PROCESS_INPUT_STREAM {
    ID3D12Resource *pTexture2D;
    UINT Subresource;
    ID3D12VideoDecoderHeap *pReferenceInfo;
